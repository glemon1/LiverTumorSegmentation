...
get_msk = lambda o: path/'train_masks_tumor_all'/f'{o.stem}_mask.png'
...
learn0 = learn0.load('tumor_segmentation_from_all_cts_resnet34ep100')
...
for i in range(loop_rerpeats):
    ...
    for pred_no in range(batch_items):
        ...
        if (np.any(a) and SAVE_MASK_PRED_FILES): # print/save masks with liver only else no save zero mask, 
            ...
            pred_mask_img.save(f"pred_masks_tum_all_CTs_100ep/{testMaskFile}")
...
ax.set_title('Tumor segmentation from all CTs\n');
